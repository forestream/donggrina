...
export default function GrowthList({ text, writer, pet, categoryName, heartCount, chatCount }: GrowthListProps) {
  return (
    <div className={styles.container}>
      ...
      <ListFooter heartCount={heartCount} chatCount={chatCount} />
    </div>
  );
}
