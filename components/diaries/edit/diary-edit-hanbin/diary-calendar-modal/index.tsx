import styles from './diary-calendar-modal.module.scss';
import { BaseSyntheticEvent, useState } from 'react';
import CalendarInstance from '@/utils/date/date.utils';
import useSelect from '@/hooks/use-select';
import { DateTime } from '@/types/calendar';
import Image from 'next/image';
import CalendarModalCalendar from '@/components/calendar-monthly/calendar-modal-calendar';
...
export default function DiaryCalendarModal({ updateDateTime, onClose }: CalendarModalProps) {
